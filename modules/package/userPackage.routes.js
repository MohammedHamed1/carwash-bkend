...
// ========================================
// MISSING USER PACKAGE ROUTES
// ========================================

// Purchase package
router.post('/', userPackageController.purchasePackage);

// Use package wash
router.post('/:id/use', userPackageController.usePackage);

// Get package history
router.get('/history', userPackageController.getPackageHistory);
